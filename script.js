...
function drawMobileControls() {
    // Perbaikan deteksi touch: deteksi maxTouchPoints agar akurat di HP asli & emulator PC
    const isTouchDevice = ('ontouchstart' in window) || (navigator.maxTouchPoints > 0);
    if (!isTouchDevice) return; 

    // Atur posisi koordinat secara konsisten (disamakan dengan area touch)
    ...
    // Samakan posisi dengan deteksi jari agar pas (misal: 100 dari kanan, 120 dari bawah)
